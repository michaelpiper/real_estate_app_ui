...
class GetFilteredProperties {
  final PropertyRepository repository;

  GetFilteredProperties({required this.repository});

  Future<Result<List<Property>, Failure>> call(PropertyFilters filters) async {
    return await repository.filterProperties(filters: filters);
  }
}
